...
export const TOOLS = [
  ...
  { id:"excel-to-pq", group:"data", icon:"🔤", title:"ตารางเป็นสูตร Power Query",
    desc:"ลากไฟล์ Excel เข้ามา ได้โค้ด #table พร้อมวาง เลือกชนิดข้อมูลของแต่ละคอลัมน์ได้เอง",
    accepts:["xlsx","csv"],
    libs:["xlsx"], keys:"power query m code #table pq โค้ด สูตร excel ชนิดข้อมูล type int64 currency", next:["excel-split","thai-encoding"] },
...
const EN_TOOLS = {
  ...
  "excel-to-pq":      ["Table to a Power Query formula", "Drop an Excel file in and get ready-to-paste #table code. Pick the Power Query type for every column"],
