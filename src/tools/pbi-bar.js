...
.pbib-chart-box{position:relative;width:100%;min-height:300px;background:#fff;border-radius:var(--r-sm);box-shadow:inset 0 0 0 1px color-mix(in srgb,#252423 10%,transparent)}
...
.pbib-group-title{margin:0;font-size:13px;font-weight:700;letter-spacing:.01em;color:var(--text-mute)}
...
.pbib-own-title{margin:0 0 4px;font-size:13px;font-weight:700;letter-spacing:.01em;color:var(--text-mute)}
