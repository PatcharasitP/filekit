...
DENSE = {"pbi-theme": 80}      # ตัวสร้างธีม: จานสี 8 ช่อง คูณหลายชุด บวกสวิตช์ของพรีวิว
# ‼️ ตัวเลขของ pbi-theme แกว่งตามจำนวนชุดสีที่โหลดสำเร็จ (วัดได้ 67 บนเครื่อง 76 บนเว็บสด)
# จึงตั้งเพดานเผื่อไว้ แต่ยังเป็นเพดาน ไม่ใช่ปล่อยฟรี ถ้าวันไหนทะลุ 80 แปลว่ามีของงอกจริง
