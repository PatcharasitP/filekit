...
# ‼️ 26/09/2026 เพิ่มเครื่องมือตัวที่ 65 (pq-combine) แล้วเกินงบ 99 ไบต์ ทั้งที่ก่อนเพิ่มเหลือที่ว่างแค่ 40 ไบต์
#    แก้ด้วยการตัดช่องว่างจัดแถวใน src/registry.js (เนื้อหาไม่เปลี่ยน) ห้ามใส่คอมเมนต์อธิบายไว้ในไฟล์นั้น
#    เพราะไฟล์นั้นโหลดตอนหน้าแรก คอมเมนต์ก็กินงบ งบนี้มาจาก brief ของพี่ปอนด์ ขยับเองไม่ได้
#    เครื่องมือตัวถัดไปจะเกินอีกแน่ ต้องเคาะก่อน (ดู .claude/decisions.md 26/09 เรื่องงบ JS หน้าแรก)
