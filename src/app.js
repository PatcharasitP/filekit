 ...
 * ‼️ เดิมบรรทัดนี้ดึง tool.css ทั้งไฟล์มาด้วย เพราะแถบใช้ .btn กับ .progress ร่วมกับหน้าเครื่องมือ
 *    ผลคือหน้าแรกโหลด 100KB เพิ่มทุกครั้งเพื่อจัดสไตล์แถบเดียว คิดเป็นหนึ่งในสี่ของทั้งหน้า
 *    ตอนนี้ยกเฉพาะกฎที่แถบต้องใช้ไปไว้ใน index.html แล้ว จึงไม่ต้องรอ tool.css อีก
 *    (ยังคงกันหน้ากระตุกได้เหมือนเดิม เพราะสไตล์มาถึงพร้อมหน้า ไม่ได้ตามมาทีหลัง) */
{
